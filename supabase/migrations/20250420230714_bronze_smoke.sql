/*
  # Fix playlist_analytics table
  
  1. Changes
    - Add unique constraint on playlist_id to prevent duplicates
...
-- Create a function to update playlist analytics when a track is played
...
-- Create a function to update store analytics when a track is played
...
DROP TRIGGER IF EXISTS update_store_analytics_on_play ON track_plays;
DROP TRIGGER IF EXISTS update_playlist_analytics_on_play ON track_plays;
