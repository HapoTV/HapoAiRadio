...
interface Props {
  storeId: string;
  storePlaylists?: Playlist[];
  autoConnect?: boolean;
}

export default function RadioPlayer({ storeId, storePlaylists = [], autoConnect = false }: Props) {
    ...
    <div className="bg-primary-800 rounded-xl p-6 shadow-lg">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 space-y-4">
          ...
          <div>
            <label htmlFor="playlistSelect" className="block text-sm font-medium text-primary-200 mb-2">
              Select Store Playlist
            </label>
            <select
              id="playlistSelect"
